...
public class BadgeManagerL2_3 : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        if (selectedID == 11)
        {
            ...
            else
            {
                badgeText.text = "YOU RECEIVED:";
                LoadImage(bannerImage, congratulation);
                Debug.Log("BadgeCount is already 4, no increment performed.");
            }
        }
        else
        {
    ...
    {
        SceneManager.LoadScene(SceneData.level2scene3);
    }

    public void gotoNextScene2()
    {
        SceneManager.LoadScene(SceneData.level2badge4);
    }
